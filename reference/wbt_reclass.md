...
- reclass_vals:
  ...
  Reclassification triplet values (new value; from value; to less than),
  e.g. '0.0;0.0;1.0;1.0;1.0;2.0'.

- assign_mode:

  Optional Boolean flag indicating whether to operate in assign mode,
